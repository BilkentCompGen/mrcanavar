...
inputs:
  - id: inputcram
    ...
    doc: 'The CRAM file generated by a read mapper such as BWA, Bowtie2, etc.'
    'sbg:fileTypes': CRAM
    secondaryFiles:
      - .crai
  - id: maskedref
  ...
  - id: unmaskedref
    ...
    inputBinding:
      position: 0
      prefix: '--unmasked-ref'
    label: Unmasked reference genome
    doc: This unmasked reference genome must match the input CRAM file.
    'sbg:fileTypes': FASTA
    secondaryFiles:
      - .fai
  - id: config
...
outputs:
  - id: dups
    ...
    outputBinding:
      glob: '*.dups.bed'
      outputEval: '$(inheritMetadata(self, inputs.inputcram))'
    'sbg:fileTypes': BED
  - id: dels
