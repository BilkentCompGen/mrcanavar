...
inputs:
  - id: inputbam
    ...
    doc: 'The BAM file generated by a read mapper such as BWA, Bowtie2, etc.'
    'sbg:fileTypes': BAM
    secondaryFiles:
      - .bai
  - id: maskedref
  ...
  - id: unmaskedref
    ...
    doc: This unmasked reference genome must match the input BAM file.
    'sbg:fileTypes': FASTA
    secondaryFiles:
      - .fai
  - id: config
